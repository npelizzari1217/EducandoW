...
describe('AlumnosXCursoXCicloController — GET /students/:studentId/memberships', () => {
  it('C-08: 200 — returns { data: StudentMembershipEnriched[] }', async () => {
    const memberships = [
      { id: 'axcc-1', courseCycleId: 'cc-1', printable: true, active: true, level: 30, academicYear: '2026', cycleName: 'Secundario 2026', grade: '1', division: 'A', createdAt: '2026-01-01T00:00:00.000Z' },
    ];
