...
export class PrismaInstitutionRepository implements InstitutionRepository {
  ...
  async findAll(active?: boolean): Promise<Institution[]> {
  ...
  private toDomain(record: PrismaInstitutionWithLevels): Institution {
    return Institution.reconstruct({
      ...
      bodyColor: record.bodyColor ? HexColor.reconstruct(record.bodyColor) : undefined,
      footerColor: record.footerColor ? HexColor.reconstruct(record.footerColor) : undefined,
      footerTextColor: record.footerTextColor ? HexColor.reconstruct(record.footerTextColor) : undefined,
  ...
  private toPrismaCreate(institution: Institution) {
    return {
      ...
      bodyColor: institution.bodyColor?.get(),
      footerColor: institution.footerColor?.get(),
      footerTextColor: institution.footerTextColor?.get(),
