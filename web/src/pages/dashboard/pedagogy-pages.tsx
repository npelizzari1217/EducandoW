...
export function CourseSectionsPage() { return <GenericPage title="Cursos" subtitle="Secciones y divisiones" url="/course-sections" columns={[{key:'name',header:'Nombre'},{key:'level',header:'Nivel'},{key:'academicYear',header:'Año'}]} fields={[{name:'name',label:'Nombre'},{name:'level',label:'Nivel'},{name:'academicYear',label:'Año lectivo'},{name:'grade',label:'Grado'},{name:'division',label:'División'},{name:'institutionId',label:'Institución ID'}]} />; }
