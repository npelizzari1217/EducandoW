# Spec: Sidebar Reorganization + Level-Based Access Filtering

> **Change**: 02-sidebar-levels | **Phase**: SPEC | **Status**: ready for DESIGN

## Domain

`sidebar-navigation` — delta spec at `openspec/changes/02-sidebar-levels/specs/sidebar-navigation/spec.md`
...
|--------|------|-------------|-----------|
| sidebar-navigation | Delta | 3 ADDED, 2 MODIFIED | 16 |
...
`.sidebar-section-label` elements MUST be hidden in tablet collapsed mode (56px icon-only state) via `display: none`.
